...
import { SIEGE_EQUIPMENT } from "../../shared/siege-equipment.js";
...
const UNIT_BLUEPRINTS: readonly BattleUnitState[] = SIEGE_EQUIPMENT.map((definition) => ({
  id: definition.id,
  ...
  integrity: 100,
  maxIntegrity: 100,
  ammunition: definition.maxAmmunition,
  maxAmmunition: definition.maxAmmunition,
  cooldown: 0,
  state: "ready",
  availableActions: [...definition.availableActions],
  availableTargets: [...definition.availableTargets],
}));
